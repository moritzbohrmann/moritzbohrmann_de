...
function AboutMe() {
  return (
    <section id="about" className="my-20 w-full px-8 sm:px-16">
      ...
      >
        <span className="w-fit bg-slate-600 text-4xl font-bold text-white sm:text-5xl lg:text-6xl dark:bg-green-400 dark:text-black">
          Über mich
        </span>
        <span className="text-md border-r-4 border-slate-600 pr-4 [word-spacing:0.5em] sm:text-lg dark:border-green-400">
